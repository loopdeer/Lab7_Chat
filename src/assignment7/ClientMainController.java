...
public class ClientMainController {
	...
	void initialize()
	{
		...
		categories.add("all");
		emojiCategory.getItems().add("all");
	...
	public void sendMessage(ActionEvent event) {
		...
		{
			addTextTextFlow(viewTextFlow, "Do not start messages with " + ClientMain.COMMANDSTART + "\n", scrollText, null, null);
			return;
		}
		...
		{
			writer.println(ServerMain.ALLNAME + " " + mainTextField.getText());
			writer.flush();
			mainTextField.setText("");
			mainTextField.requestFocus();
		}
	...
	public void talkTo(ActionEvent event) {
		...
		writer.println(ClientMain.COMMANDSTART + " startconv " + people);
		writer.flush();
	}
	...
	{
		writer.println(ClientMain.COMMANDSTART + " getOnlineUsers ");
		writer.flush();
	}
	...
	public void handleMessage(String sender, String recip, String message)
	{
		...
		if(recip.equals(ServerMain.ALLNAME))
		{
	...
	{	
		Platform.runLater(new Runnable(){
			...
			public void run() {
				...
				if(sender.equals(ClientMain.getID()))
	...
	private void emojiSearch(String category)
	{
		...
		HashSet<Emoji> categoryEmojis = new HashSet<Emoji>();
		if(category.equals("all"))
		{
			for(String s : allEmojis.keySet())
			{
				categoryEmojis.addAll(allEmojis.get(s));
			}
		}
		else
			categoryEmojis.addAll(allEmojis.get(category));
