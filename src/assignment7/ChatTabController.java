...
public class ChatTabController {
	...
	@FXML
	public void openEmojis(Event e)
	{
		cc.openEmojis(e);
	}
	...
	public void sendMessage(ActionEvent event) {
		...
		{
			cc.addTextTextFlow(viewTextFlow, "Do not start messages with " + ClientMain.COMMANDSTART, scrollText, null, null);
	...
	public void talkTo(ActionEvent event) {
		...
		if(people.contains(ClientMain.getID()))
			people = people.replaceAll(ClientMain.getID(), "");
